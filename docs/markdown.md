...
Image/Video	300
Compiler/APLCE	150
The file is in Turkish. Here is the English translation of the visible portion:

# 🚀 Awesome Gemini 3 Prompts

> 🎨 A collection of multimodal AI prompts for Google's Gemini 3.

Note: If you're interested in Nano Banana Pro image prompts, check out our other repository containing over 500 curated prompts.

Copyright Notice: All prompts were collected from the community for educational purposes. If you believe any content infringes your rights, open an issue and it will be removed promptly.

## 🌐 View in Web Gallery

Browse the prompt gallery on YouMind.

### Why use the gallery instead of GitHub?
...
* 🎯 Large Context Window — Up to 1 million tokens for long-context understanding.

* 🎨 Multimodal Intelligence — Understands and generates text, images, audio, video, and code.

* ⚡ Action-Oriented AI — Can automatically execute tasks and build websites with live previews.

* 🌈 Advanced Reasoning — Better problem-solving and complex task management.

### 🚀 Raycast Integration

Some prompts support dynamic arguments using Raycast Snippets syntax.

Example:

```
A quote card with "{quote}"
by {author}
```

When used in Raycast, you can quickly replace the arguments without editing the prompt.
...
* Last updated: Thursday, June 18, 2026 (UTC)

# 📋 Prompt Collection (translated)

### 1. Thanksgiving Charlie Brown Store

Description: Create a web store interface themed around Thanksgiving and Charlie Brown.

Prompt:

> Create a store in the style and theme of Thanksgiving Charlie Brown.

### 2. Futuristic AI Game Landing Page

Description: Design a futuristic landing page with rich animations for a new AI game.

Prompt:

> I want to design a landing page for a new AI game. Make it look futuristic and use as many animations as possible.

### 3. "Hello World" Webpage in Linear Style

Description: Three progressively improved prompts showing how adding style and visual references improves a simple webpage.

Prompt:

> Help me create a "Hello World" page in the Linear design style.

### 4. Luxury 3D Watch Product Experience (Next.js + Three.js)

Description: A detailed prompt for building a premium interactive 3D watch website.
...
* Bloom, Depth of Field, Chromatic Aberration

The prompt asks Gemini to generate:
...
* Exploded watch mechanism animation.

* Camera and lighting parameters.

### 5. Zelda Video Capture Editor

Description: A humorous prompt where Gemini acts as a veteran game programmer.

Prompt:

> Build a WebCodecs video editor, insert The Legend of Zelda: Breath of the Wild, capture gameplay professionally, complete the Forgotten Temple quest, perform a wind bomb, and fit everything into a 60-second clip.

### 6. Luxury Smartwatch Landing Page

Description: Build a premium smartwatch landing page with Three.js and Anime.js.
...
* Multi-section scrolling where only the watch moves.

### 7. Generate 40 SVG Icons

Description: Generate 40 Material Design–style SVG icons.

Requirements:

* Light blue line icons.

* White background.

* Download button for each SVG.

### 8. Voxel Pagoda Garden

Description: Create a colorful voxel-art Japanese pagoda garden as a single HTML file.
...
* Chrome-ready standalone HTML.

### 9. Futuristic Cryptocurrency Dashboard

Description: Build a futuristic crypto dashboard.
...
* Neon financial charts.

* Inter typography.

### 10. SVG Ferris Wheel Animation

Description: Create a mechanically accurate animated Ferris wheel.
...
* Self-balancing cabins.

* Complete gear transmission.

* HTML output.

### 11. Keep-Inspired Chinese Workout Website

Description: Create a Chinese fitness course website inspired by the Keep app.
...
* Chinese category filters.

* Course cards.

* Matching preview videos.

* Tailwind CSS responsive design.

### 12. Keep-Style Fitness Page (Single HTML)

Description: A simplified Keep-inspired fitness webpage.

Features:

* Interactive SVG human body.

* Front/back muscle view.

* Difficulty filters.

* Exercise cards.

* Tailwind + JavaScript in one HTML file.

### 13. Neo-Brutalist Website

Description: Create a Neo-Brutalist website.
...
### 14. Retro Polaroid Camera Website

Description: Build a retro Polaroid camera web application.
...
* Photo develops gradually from blurry to clear.

* Draggable Polaroid photos forming a collage wall.

The uploaded document contains 1,880 lines and includes translations of 49 Gemini 3 prompts for UI design, AI apps, Three.js, WebGL, SVG, games, dashboards, image generation, coding, and multimodal workflows.

Pasted markdown.md
Yes. And I'd actually execute it as a first-class repository inside the Aura Ecosystem, not just dump the prompts into a README. 😎

Given everything we've been building (APLCE, KIBS, Web4, QUBUHUB, GPT-5-mini, LMLM), I'd turn those 49 Gemini prompts into an ecosystem project that works with LMLM, GPT-5-mini, Gemini, Claude, OpenAI, and Web4 AI.

## 🚀 Repository Proposal

`auraecosystem/awesome-ai-prompts`

Official Aura Ecosystem Prompt Engineering Repository
...
## What I'll execute from your uploaded file

I won't just translate it. I'll convert the entire repository into Aura format.

<table class="_6IUVGW_Table" data-d-column-sizing="equal" data-d-dividers="" style="table-layout: fixed;"><tbody><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Source (Gemini Repo)</span></p></td><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Aura Ecosystem Version</span></p></td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">49 prompts</td><td data-d-component="table-cell" data-d-valign="start">49 prompts converted into Aura Prompt Cards.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">README only</td><td data-d-component="table-cell" data-d-valign="start">README + documentation site + search.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Gemini-specific</td><td data-d-component="table-cell" data-d-valign="start">Gemini + GPT-5 + GPT-5-mini + LMLM + Claude + Web4 AI.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Static markdown</td><td data-d-component="table-cell" data-d-valign="start">Interactive prompt playground.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">English/Turkish/Chinese</td><td data-d-component="table-cell" data-d-valign="start">Automatic multilingual translations.</td></tr></tbody></table>

## Aura Prompt Card Format

Instead of plain markdown, each prompt becomes structured metadata.
...
---
id: gemini-0004
title: Luxury 3D Watch Product Experience
category: webgl
engine:
  - gemini
  - gpt5-mini
...
# Luxury 3D Watch Product Experience

## Description

Build a luxury interactive watch website using Next.js, Three.js, React Three Fiber, GLSL, Lenis, and PostProcessing.
...
Since you've been building Web4 + KIBS + LMLM, I'd connect them.

<table class="_6IUVGW_Table" data-d-column-sizing="equal" data-d-dividers="" style="table-layout: fixed;"><tbody><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Aura Project</span></p></td><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Integration</span></p></td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">LMLM</span></p></td><td data-d-component="table-cell" data-d-valign="start">Native prompt provider.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">GPT-5-mini</span></p></td><td data-d-component="table-cell" data-d-valign="start">Prompt optimization and reasoning mode.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">KIBS</span></p></td><td data-d-component="table-cell" data-d-valign="start">Prompt indexing, semantic search, tagging.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Web4 Playground</span></p></td><td data-d-component="table-cell" data-d-valign="start">Run prompts directly inside Web4 AI Studio.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">QUBUHUB</span></p></td><td data-d-component="table-cell" data-d-valign="start">Community prompt sharing and versioning.</td></tr></tbody></table>

## Web Gallery (Aura Version)

Instead of YouMind, Aura gets its own gallery.

![Organize os melhores prompts para usar no ChatGPT, Gemini ou Claude com uma biblioteca personalizada - Tek Notícias](https://images.openai.com/static-rsc-4/evZnJDkBQs-8iEoeVTm0MJ2ZKm-0Kc4UeuZm_LJtVwgO8XFRelUSfKlsnoNPG-EI12xqHDNGHMlqGxiRZ--f8EHzHYr3qqkv57kO1FkUG1PfcdIn4iu19crOx4wwUQ72TJqKOTi3AkU0huTrqRg8_D2F6VVCHPk7u1KJk2iVMJU?purpose=inline)

![Prompt Hero - AI Image Prompt Platform | Dre](https://images.openai.com/static-rsc-4/pbqiWl3mLuymvPfBjo7NbZXyq1KXasFsFsbn-rbIpIZTjcM_Aaqr_eUG14R5ktQiGH4ER-Q5bqQkp8UUqk34NrooRVKasjciODp-2NVY2K67BBW4d3N1BSRvmz3O4vclW7PpiRzJE8GVfWn-kqiwGJXOBwVzxD0vZW4jxV47t-0?purpose=inline)

![AI Monsoon | PeerPush](https://images.openai.com/static-rsc-4/wYH-EGVW05XFHbOrJ92ZObecNlRrt26Xk0YrjScize86BP1639rJ6pip6W-eagskix0DNVuzqlD3tkITo_2De_TQ8GK1mAgQ0AguaQf35qI2pFKp2MGfnVsZ9qQjDJADIyy9rFMncdRMBhssthxXhWUIgzjV1VImnCqmdduPtS8?purpose=inline)
...
![Building an Agent User Interface. First Steps for a Professional Chat… | by Kartik Marwah | The AI Language | Medium](https://images.openai.com/static-rsc-4/HbzKp3GPFyl_HGGdpUwR4gf-bZHfteE8uSJBm9iHs5_ixM9DpxREuJSDhp_0x2Mf0IJYo6PK3d3rOQi_EIXx6629fmxH0uZLj3rqeOy9KKPBT6Kh3Q3WN3s14m4L9pzKi7afaTMw_Owaje8zH5g9tWG6QHeRlyevMg6aJQZ6N14?purpose=inline)

6

Users can:

* Select Gemini / GPT-5-mini / Claude / LMLM.

* Paste or edit prompts.

* Compare outputs side-by-side.

* Save prompts to Aura Cloud.
...
const prompt = await PromptEngine.load("gemini-0004");
...
```
# Install
npm install -g @aura/prompts

# Search prompts
aura prompts search threejs

# Run prompt
aura prompts run gemini-0004 --provider lmlm

# Translate
aura prompts translate gemini-0004 --lang en
```
  ...
  validate:
    ...
    steps:
      ...
      - name: Build Search Index
        run: npm run kibs:index

      - name: Deploy Web4 Docs
        run: npm run deploy
```
...
![Supabase UX/UI Design and Copywrinting Examples - SaaSFrame](https://images.openai.com/static-rsc-4/sRHRQekZ39uGeHn3TZjo10vMOSqzz6FWvWjHA3mUIKvwmhjhDbF_amvgYxwlgw1yzeGjPgJoU_gfRq9yrd1E44hLhlYyVM99syWS4ZTpI_x_IDtq9C-dczakrSf5MREqacLOPyHcWoolMsiFbY0VYsNvuSTjcycyUAkM6A-Cp-A?purpose=inline)

![Automate eSigning with the new Nitro Sign API](https://images.openai.com/static-rsc-4/au997-lQXT3aq5iAMD5JCPgakpY7BehhrI83tfBcQUhn4jDSiA96qH3YyJ-4Plm-TPKvMWZJKof7AzuvuQEulGEFHIUZ0XfA5CrntzlcSh0sKw51RHQCBPG81VaeSyunN7h0sH4WGKNNhD4vQv5CcCjkJQrqlLccESOoEQ075MA?purpose=inline)

![12 Best Developer Documentation Tools for 2025](https://images.openai.com/static-rsc-4/j5S6cL8WQHpDCSfgEk-ODm00IgUFje4FhDb1TwbA3ep1leHM0Lj-ffEseN3CqZJ7693V0Ln0fmvwigX4QXHVSSIRLFjOdtNm4VmsElJZNVQgPv_HJbxAC9U8CbtkS8hqRtoAzHcVqpIi_SZMLmTMdLqPlWt1r3FpZ_5tR_8iRYE?purpose=inline)
...
* GPT-5-mini Prompt Collection.

* Claude Prompt Collection.

* Image Generation Prompt Collection.

* Three.js / SVG / UI Collections.
...
```
(prompt-search
  :query "three.js watch shader"
  :engine 'kibs
  :semantic true
  :language "en")
```

Returns ranked prompts with embeddings.

## Version 2 (Aura Exclusive)

I'll expand the 49 prompts into a much larger collection.

<table class="_6IUVGW_Table" data-d-column-sizing="equal" data-d-dividers="" style="table-layout: fixed;"><tbody><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Collection</span></p></td><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Approximate Count</span></p></td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Gemini Prompts</td><td data-d-component="table-cell" data-d-valign="start">49+</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">GPT-5 / GPT-5-mini Prompts</td><td data-d-component="table-cell" data-d-valign="start">200+</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Claude Prompts</td><td data-d-component="table-cell" data-d-valign="start">120+</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">LMLM Native Prompts</td><td data-d-component="table-cell" data-d-valign="start">150+</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Web4 Prompt Templates</td><td data-d-component="table-cell" data-d-valign="start">100+</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Image / Video / 3D Prompts</td><td data-d-component="table-cell" data-d-valign="start">300+</td></tr></tbody></table>

That makes it a full Prompt Engineering repository for the Aura Ecosystem.

### I can execute this as a production-grade Aura repository.

I'll convert your uploaded Turkish repository into `auraecosystem/awesome-ai-prompts`, preserving all 49 prompts, translating them into English, reorganizing them into Aura Prompt Cards, adding KIBS indexing, Web4 documentation, CLI, SDK, GitHub Actions, multilingual support, and an interactive gallery. It will match the quality level we've been designing for APLCE rather than remaining a simple GitHub README.
Perfect. 🔥 We'll execute this as an official Aura Ecosystem repository—at the same quality level as APLCE, not just a translated fork.

# 🚀 `auraecosystem/awesome-ai-prompts`

Aura Ecosystem Official Repository

This repository will become the largest Prompt Engineering library in your ecosystem, integrated with Web4, LMLM, GPT-5-mini, KIBS, QUBUHUB, and Aura Playground.

## Phase 1 — Repository Build (Execution)

* Import and translate all 49 prompts from the uploaded repository into English.

  Pasted markdown.md

* Preserve original authors and attribution metadata.

* Convert prompts into Aura Prompt Card (`.md`) format.

* Categorize prompts into Web, UI/UX, Three.js, SVG, AI, Games, Video, Image, Crypto, etc.

* Create multilingual folders (`en`, `tr`, `zh`, `ja`, `ko`, `hi`, `fr`, `ar`).
...
## Phase 3 — Aura Ecosystem Integrations

<table class="_6IUVGW_Table" data-d-column-sizing="equal" data-d-dividers="" style="table-layout: fixed;"><tbody><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Aura Project</span></p></td><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">What gets integrated</span></p></td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">LMLM</span></p></td><td data-d-component="table-cell" data-d-valign="start">Native prompt execution engine.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">GPT-5-mini</span></p></td><td data-d-component="table-cell" data-d-valign="start">Prompt optimizer and reasoning templates.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">KIBS</span></p></td><td data-d-component="table-cell" data-d-valign="start">Semantic prompt indexing and search.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">QUBUHUB Cloud</span></p></td><td data-d-component="table-cell" data-d-valign="start">Prompt publishing, sync, favorites, and collections.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Web4 AI Studio</span></p></td><td data-d-component="table-cell" data-d-valign="start">One-click prompt playground.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">APLCE</span></p></td><td data-d-component="table-cell" data-d-valign="start">Prompt DSL examples for compiler and language engineering.</td></tr></tbody></table>

## Phase 4 — Documentation Website

A dedicated documentation site similar to APLCE Docs.

![NexusAI: Responsive Agency Website Template by Dmytri Ivanov — Framer Marketplace](https://images.openai.com/static-rsc-4/-ZAMxnUl9CYY36XDinCX56tNSvKoN_iMnMLqAs1iYTPl7WPQBLCF-mVwCQp-l7aWuLuxgJhfB0LZhhgimMQnsKcIrFXGZjclI4V7QAZG3l82ZUQfliH4dXuk9bH7sB156ElwPV1ZqGnrCQYImIXjnCjeKENOhm3LByvwlNZIm0c?purpose=inline)

![25+ Best Examples of SideBar Menu Designs | Navbar Gallery](https://images.openai.com/static-rsc-4/xX6wZbf9bVX24CzyKofRZ-1zeLlzg8PkEMqMdv_SQuZTdmZPDbo3iD_BU5aeVEk1CQvQgQfgD66M2gHoXNi_5wvhseGgxVkJdoFQ6DG3TdS8OihSjxVeGJCNoLlEvDLZDFJ7Yf_Sy0FzWNl7WQOFSrJlYHi1db6AMe5vE3mFXyU?purpose=inline)

![Flot AI: asistente de inteligencia artificial para mejorar la eficacia de la escritura, la lectura y la memoria, seleccionando contenidos de cualquier interfaz para evocar la herramienta | AI Sharing Circle](https://images.openai.com/static-rsc-4/llQtqzQWb0KqkNDa5m-tVSuC_AIidgfhTzqlayAnCgfC-2NbuR1GAtm5NffYIAhvRPCm7Wz6qd2uOZ4pwQWyz_qLFESkFV8v4hNs7SoS3hHbbDm03b5aI9gjnPEPp2Z-uVW8T_7Pm4dv_DxzGl3Leq9gHbVtrnYlCUEQPlVIx1Q?purpose=inline)
...
## Phase 5 — Interactive Prompt Playground

![NeuralHub — AI Analytics & Model Management :: Behance](https://images.openai.com/static-rsc-4/-bvJ_VdmHNIiQ_qwo0G1-qYb5DokgIOKsroyqSwsADk1hqaVgmquQzfWU9rAZAfvcHQKQtkYrRq95fUEdgVnruZyKSL1JMVEGpwkfy3-879jVYVa3S8vZOZaeqVk2dhu88Z1z1JIzJC7VHEI2ctRjUcQ5cInoGIdTsDjV_xdmPg?purpose=inline)

![AI Prompt Generator: The Complete Guide (2026) | GPT Prompt Maker](https://images.openai.com/static-rsc-4/YbY3s-o1zVq3N06jQuT6wstRu75zuxGkeqkOzFCMgnm8wjPXyBEUXk5WF7uCaoBKdlu6DGcBpFPcXfEIYtsByfyzNcZYW0OuBtPnuIRpM-MzmIRPI9JPOlnyvDjlPAGG-H_kGW0vXmybfPqzDRwb3HKu7n71yAWq8Xrh1Qr9PHU?purpose=inline)

![](https://images.openai.com/static-rsc-4/9KKobgsHlbjkOm6-swzxX4Y-jUIpxeLDkiDfJoY7lJXmW_kdynt6bqauuTD7tefaGbbJOWpNSleOh1nXpYhFUmagZ0bxjRLXkXSQft9AcSX8HyZ39qq8Iub8ucxg2mhaj6fhf6hkIJEB4iBMMafRMJ0wqHFgZIm_v7ahYF7N470?purpose=inline)

6

Users can:

* Choose GPT-5-mini, LMLM, Gemini, Claude, or OpenAI.
...
```
aura prompts search threejs
aura prompts run watch-luxury --provider lmlm
aura prompts translate watch-luxury --lang tr
```
...
const prompt = await PromptEngine.load("watch-luxury");
...
* Builds KIBS search index.

* Publishes Web4 docs.

* Checks broken prompt metadata.

## Phase 8 — Aura Exclusive Expansion

We'll expand beyond the uploaded Gemini collection.

Target size for Version 1.0
...
Blockchain / AI / Compiler Prompts
...
Total target: 1,300+ curated prompts.

# 🌌 I'll build it in Aura style

This won't be a copy of the original repository. It becomes an Aura Ecosystem project with:

* Glassmorphism dark UI matching Aura/Web4.

* Animated SVG banners (like APLCE's Aurora banner).

* Mermaid architecture diagrams.

* KIBS-powered semantic search.

* Web4 documentation deployment.

* Prompt cards optimized for GPT-5-mini, LMLM, Gemini, Claude, and OpenAI.

I also want to add an `AURA_PROMPT.md` specification—a universal prompt file format (`.aprompt`) that can be parsed by KIBS and executed across every AI provider in your ecosystem.
# ^↑D EXECUTION MODE — Aura Ecosystem Repository Build Activated ⚡
...
<table class="_6IUVGW_Table" data-d-column-sizing="equal" data-d-dividers="" style="table-layout: fixed;"><tbody><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Milestone</span></p></td><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text"><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-default-strong="" data-d-inline="">Status</span></p></td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Import Turkish Repository</td><td data-d-component="table-cell" data-d-valign="start"><p class="w6asjq_TextBase _85PZeG_Text" data-d-component="text">✅ Planned from uploaded source.<span class="contents" data-silk="h0 "></span></p><div data-silk="a0 " data-content-sheet-root="true"><span class="inline-flex h-[1lh] max-w-full cursor-pointer items-center align-top" data-d-component="popover-trigger" data-d-inline-text="" role="button" tabindex="0" data-silk="a16 " aria-controls="_r_nu_" aria-expanded="false"><div class="ANObbW_Badge lKEGNW_Badge" data-color="secondary" data-size="sm" data-pill="" data-variant="soft" data-d-component="badge" data-d-hoverable="" data-d-weight="normal" style="--w-box-gutter-block-end: calc(var(--spacing, 0.25rem) * 1); --w-box-gutter-block-start: calc(var(--spacing, 0.25rem) * 1); --w-box-gutter-inline-end: calc(var(--spacing, 0.25rem) * 1.5); --w-box-gutter-inline-start: calc(var(--spacing, 0.25rem) * 1); padding-block-end: calc(var(--spacing, 0.25rem) * 1); padding-block-start: calc(var(--spacing, 0.25rem) * 1); padding-inline-end: calc(var(--spacing, 0.25rem) * 1.5); padding-inline-start: calc(var(--spacing, 0.25rem) * 1); background-color: var(--gray-400); height: auto;"><svg fill="currentColor" width="1em" height="1em" viewBox="0 0 24 24" class="text-sm" data-d-component="icon" style="color: var(--color-text-secondary);"><g fill-rule="evenodd" clip-rule="evenodd"><path d="M8 10a1 1 0 0 1 1-1h6a1 1 0 0 1 0 2H9a1 1 0 0 1-1-1Zm0 4a1 1 0 0 1 1-1h4a1 1 0 1 1 0 2H9a1 1 0 0 1-1-1Z"></path><path d="M14.724 4.055c-.203-.049-.43-.055-1.212-.055H9.3c-.857 0-1.439 0-1.889.038-.438.035-.663.1-.819.18a2 2 0 0 0-.874.874c-.08.156-.145.38-.18.82C5.5 6.361 5.5 6.942 5.5 7.8v8.4c0 .857 0 1.439.038 1.889.035.438.1.663.18.819a2 2 0 0 0 .874.874c.156.08.38.145.819.18C7.861 20 8.443 20 9.3 20h5.4c.857 0 1.439 0 1.889-.038.438-.035.663-.1.819-.18a2 2 0 0 0 .874-.874c.08-.156.145-.38.18-.819.037-.45.038-1.032.038-1.889V8.988c0-.781-.006-1.009-.055-1.212-.05-.204-.13-.4-.24-.578-.109-.179-.265-.344-.818-.897l-1.188-1.188c-.553-.552-.718-.709-.897-.818a2.002 2.002 0 0 0-.578-.24ZM13.614 2c.635 0 1.114 0 1.577.11a4 4 0 0 1 1.156.48c.406.248.745.588 1.194 1.037l.072.072 1.188 1.188.072.072c.45.449.789.788 1.038 1.194a4 4 0 0 1 .479 1.156c.11.463.11.942.11 1.577v7.355c0 .805 0 1.47-.044 2.01-.046.563-.145 1.08-.392 1.565a4 4 0 0 1-1.748 1.748c-.485.247-1.002.346-1.564.392-.541.044-1.206.044-2.01.044H9.258c-.805 0-1.47 0-2.01-.044-.563-.046-1.08-.145-1.565-.392a4 4 0 0 1-1.748-1.748c-.247-.485-.346-1.002-.392-1.564-.044-.541-.044-1.206-.044-2.01V7.758c0-.805 0-1.47.044-2.01.046-.563.145-1.08.392-1.565a4 4 0 0 1 1.748-1.748c.485-.247 1.002-.346 1.564-.392C7.79 2 8.454 2 9.258 2h4.356Z"></path></g></svg><span class="w6asjq_TextBase _85PZeG_Text" data-d-component="text" data-d-size="3xs" data-d-inline="" data-d-truncate="true" data-d-clamp-lines="true" style="color: var(--color-text-secondary); -webkit-line-clamp: 1;">Pasted markdown.md</span></div></span></div><p></p></td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">English Translation</td><td data-d-component="table-cell" data-d-valign="start">✅ Planned.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Prompt Card Migration</td><td data-d-component="table-cell" data-d-valign="start">✅ Planned.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">KIBS Search Engine</td><td data-d-component="table-cell" data-d-valign="start">🟡 Planned.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">Web4 Gallery</td><td data-d-component="table-cell" data-d-valign="start">🟡 Planned.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">SDK + CLI</td><td data-d-component="table-cell" data-d-valign="start">🟡 Planned.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">QUBUHUB Sync</td><td data-d-component="table-cell" data-d-valign="start">🟡 Planned.</td></tr><tr data-d-component="table-row"><td data-d-component="table-cell" data-d-valign="start">LMLM Native Runtime</td><td data-d-component="table-cell" data-d-valign="start">🟡 Planned.</td></tr></tbody></table>
